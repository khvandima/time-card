...
(function (global, factory) {
   ...
   (function (TokenType) {
      ...
      TokenType[(TokenType["INCLUDE_MATCH_TOKEN"] = 10)] =
         "INCLUDE_MATCH_TOKEN";
      ...
      TokenType[(TokenType["UNICODE_RANGE_TOKEN"] = 30)] =
         "UNICODE_RANGE_TOKEN";
   ...
   (function (PropertyDescriptorParsingType) {
      ...
      PropertyDescriptorParsingType[
         (PropertyDescriptorParsingType["LIST"] = 1)
      ] = "LIST";
      PropertyDescriptorParsingType[
               ...
               return __generator(this, function (_a) {
                  switch (_a.label) {
                     case 0:
                        ...
                        if (
                           typeof this.clonedReferenceElement === "undefined"
                        ) {
                           return [
                              2 /*return*/,
                              Promise.reject(
   ...
   var parseStackTree = function (
      ...
      parent.container.elements.forEach(function (child) {
         ...
         var paintContainer = new ElementPaint(
            child,
            parent.getParentEffects()
         );
                     ...
                     _loop_1 = function (backgroundImage) {
                        ...
                        return __generator(this, function (_f) {
                           switch (_f.label) {
                              case 0:
                                 if (
                                    !(backgroundImage.type === CSSImageType.URL)
                                 )
                                    return [3 /*break*/, 5];
                                 image = void 0;
